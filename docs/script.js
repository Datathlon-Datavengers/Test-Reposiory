...
const butt = document.getElementById('like-btn');
...
// Ste/*  */p 3: Create an event listener that increases the likes when the user presses the like button 

butt.addEventListener('click', addLike);
...
//2: Add an event listener (addEventListener)
  const pic_image = document.getElementById('post');

  pic_image.addEventListener('dblclick', addLike);
